...
export function friendlyAuthError(
  ...
  if (
    ...
    return {
      ...
      description:
        "Open the verification email from Supabase or DocketHQ, then come back and log in.",
    };
  }
  ...
  if (
    ...
    return {
      ...
      description:
        "Use login instead, or reset the password if you cannot access this email.",
    };
  }
